package com.mycompany.launchingfromnativeui;
...
public class WelcomeActivity extends android.app.Activity {
	...
	protected void onCreate(android.os.Bundle savedInstanceState) {
		...
		showDefaultButton.setText("Show Default Screen");
		...
		showPolygonsButton.setText("Show Polygons Screen");
		...
		showFishiesButton.setText("Show Fishies Screen");
		...
		showClockButton.setText("Show Clock Screen");
