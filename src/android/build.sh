...
"$SDK_PATH/tools/android" update project --target 1 -p .
checkError

"$SDK_PATH/tools/android" update lib-project --target 1 -p "$CORONA_PATH/Corona/android/lib/Corona"
checkError

# Uncomment if using facebook
# "$SDK_PATH/tools/android" update lib-project --target 2 -p "$CORONA_PATH/Corona/android/lib/facebook/facebook"
# checkError
